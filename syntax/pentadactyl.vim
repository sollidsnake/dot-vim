...
syn keyword pentadactylCommand loadplugins lpl gr[oup] ! run Clistk[eys] Clk
    ...
    \ map ma[rk] marks mes[sages] messc[lear] mkp[entadactylrc] mkv[imruntime]
    ...
    \ pref[erences] prefs pr[ivate] pr0n porn pw[d] qma[rk] qmarks q[uit]
    \ quita[ll] qa[ll] redr[aw] reg[isters] reh[ash] re[load] reloada[ll]
    \ res[tart] runt[ime] sa[nitize] sav[eas] w[rite] sbcl[ose] scrip[tnames]
    \ se[t] setg[lobal] setl[ocal] sideb[ar] sb[ar] sbop[en] sil[ent] so[urce]
    \ st[op] stopa[ll] sty[le] styled[isable] styd[isable] stylee[nable]
    \ stye[nable] stylet[oggle] styt[oggle] tab taba[ttach] tabc[lose]
    \ tabde[tach] tabd[o] bufd[o] tabdu[plicate] tabl[ast] bl[ast] tabm[ove]
    \ tabn[ext] tn[ext] bn[ext] tabo[nly] tabopen t[open] tabnew tabp[revious]
    \ tp[revious] tabN[ext] tN[ext] bp[revious] bN[ext] tabr[ewind] tabfir[st]
    \ br[ewind] bf[irst] time tlistk[eys] tlk tm[ap] tno[remap] toolbarh[ide]
    \ tbh[ide] toolbars[how] tbs[how] toolbart[oggle] tbt[oggle] tunm[ap]
    \ una[bbreviate] u[ndo] undoa[ll] unl[et] unm[ap] unpin[tab] verb[ose]
    \ ve[rsion] vie[wsource] vlistk[eys] vlk vm[ap] vno[remap] vunm[ap]
    \ winc[lose] wc[lose] wind[ow] winon[ly] wino[pen] wo[pen] wqa[ll] wq xa[ll]
    \ y[ank] zo[om]
    \ contained
...
let s:toggleOptions = ["banghist", "bh", "errorbells", "eb", "exrc", "ex",
    ...
    \ "jsdebugger", "jsd", "more", "online", "timeout", "tmo", "usermode", "um",
    \ "visualbell", "vb"]
